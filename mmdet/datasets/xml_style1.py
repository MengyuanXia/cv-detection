...
class XMLDataset(BaseDetDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for img_id in img_ids:
            ...
            print(f"Constructed file_name path: {file_name}")
            print(f"Constructed xml_path: {xml_path}")
    ...
    def parse_data_info(self, img_info: dict) -> Union[dict, List[dict]]:
        ...
        if not osp.exists(img_info['xml_path']):
            print(f"File not found: {img_info['xml_path']}")
            raise FileNotFoundError(f"File not found: {img_info['xml_path']}")
